...
class SettingsActivity : AppCompatActivity() {
    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            val darkModePref: ListPreference? = findPreference(getString(R.string.pref_key_dark))
            darkModePref?.setOnPreferenceChangeListener { preference, newValue ->
                val darkMode: DarkMode = enumValueOf(newValue.toString().uppercase(Locale.ROOT))
